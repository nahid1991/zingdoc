							...
							<div class="pof-content">
								...
								<div class="pof-desc padding">
                                    ...
                                    <div class="doctorsignup-holder edit-holder">
										...
										<div class="doctorsignup-holder edit-holder">
											<label for="">Entity Overview</label>
											 <textarea class="edit-textarea" name="overview"></textarea>
										</div>
										<div class="pof-edittitle">
											<h5>Contact Info</h5>
										</div>
									<div class="doctorsignup-holder edit-holder">
									    ...
									    <input name="location" required="" type="text" class="form-control" value="">
									</div>
									<div class="doctorsignup-holder edit-holder">
										<label for="">Address</label>
										 <textarea class="edit-textarea" name="address">
										</textarea>
									</div>
									...
									<div class="doctorsignup-holder edit-holder">
									    ...
									    <input id="specilzations" name="specializations" required="" type="text" class="form-control"  value="">
									...
									<div class="doctorsignup-holder edit-holder">
										<label for="">Awards and Recognitions</label>
										 <textarea class="edit-textarea" name="award"></textarea>
									</div>
									<div class="doctorsignup-holder edit-holder">
